...
class Query(models.Model):
    ...
    structured_plan = models.JSONField(default=dict, blank=True, help_text="Validated QueryOptimizer JSON execution schema")
    follow_up_questions = models.JSONField(default=list, blank=True, help_text="Contextual follow-up suggestions")
    evidence_graph = models.JSONField(default=dict, blank=True, help_text="Multi-source evidence graph mapping")
